...
\else
	...
	\newcommand*\titlestyleright{
		...
		\begin{minipage}[c]{0.35\linewidth}
			\vspace{0pt}
			\includegraphics[width=\linewidth]{images/ost_logo_de_rgb-eps-converted-to}
		\end{minipage}
		%
		...
		\begin{minipage}[c]{0.25\linewidth}
			\vspace{0pt}
			\includegraphics[width=\linewidth]{images/legic-logo}
		\end{minipage}
		\vspace{2cm}
		\sffamily
		\vspace*{\stretch{6}}
		...
		\vspace{2cm}\par
		{\LARGE\sffamily\bfseries Flurin Arquint}\par
		{\sffamily\ \href{mailto:flurin.arquint@ost.ch}{flurin.arquint@ost.ch}}\par
		\vspace{0.5cm}
		{\LARGE\sffamily\bfseries Jan Brupbacher}\par
		{\sffamily\ \href{mailto:jan.brupbacher@ost.ch}{jan.brupbacher@ost.ch}}\par
		\vspace{1cm}
